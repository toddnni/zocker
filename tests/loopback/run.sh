...
echo "## Running a container without ipv6 and checking ipv4:"
zocker run -l local4 -n looptest base 'ifconfig lo0 | grep "inet 127\."'

echo "## Removing a container:"
zocker rm looptest

echo "## Running a container without ipv6 and checking ipv6:"
zocker run -l local4 -n looptest base 'ifconfig lo0 | grep -v "inet6 fe80:\."'
